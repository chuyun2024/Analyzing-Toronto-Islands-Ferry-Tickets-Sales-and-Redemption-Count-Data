---
title: "Patterns of Toronto Islands Ferries Tickets Sales and Redemption and potential Solutions"
subtitle: ""
author: 
  - Yun Chu
...
ggplot(data, aes(x = formatted_date)) +  # Define the data and aesthetic mappings; formatted_date on the x-axis
  ...
  scale_color_manual(name = "Legend",             # Customize the color scale for the legend
                     values = c("Sales" = "#2b5b84", "Redemption" = "#98df8a")) +  # Assign specific colors to the lines
